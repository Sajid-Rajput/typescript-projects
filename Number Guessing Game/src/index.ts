  ...
  do {
    ...
    do {
      ...
      if (Number(user_number) > guessingValue) {
        console.log(
          chalk.redBright(`Your number ${user_number} is greater than the guess number.\n`)
        );
        --lives;
      } else if (Number(user_number) < guessingValue) {
        console.log(chalk.redBright(`Your number ${user_number} is less than the guess number.\n`));
        --lives;
      } else if (Number(user_number) === guessingValue) {
        console.log(chalk.greenBright(`Congratulation! You guessed the right number.\n`));
      }
